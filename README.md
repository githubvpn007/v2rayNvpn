[**2021年8月9更新**](#1)、翻墙、免费翻墙、免费科学上网 、外网游戏、国外游戏、免费节点、免费梯子、免费ss/ssr/trojan/v2ray节点、蓝灯、谷歌商店、翻墙梯子、每天更新、上外网、外网、外贸、vpn推荐、ShadowsocksR、 Shadowsocks、ClashR、vmess 、Clash、V2ray、ClashX、vpn
...
### [我最喜欢的科学上网方案，在文章的第五点我会着重教大家如何使用这种翻墙方式！！！！](#使用教程)  
...
|推荐机场|理由|使用说明|
|:-----------------:|:-----------------:|:-----------------:|
|[**V2云→**](https://cwv587.com/auth/register?code=SZIS)|最近使用感觉不错、速度延迟只有11ms、免费试用、支付支付宝|[1.点击注册 → ](https://cwv587.com/auth/register?code=SZIS)<br/> 2.在首页获取订阅连接 |
|[**速鹰666→**](https://suying222.net/auth/register?code=5J5c)|老牌大机场8K、支持退款、节点超多(根据购买档次不同给到的节点也不同，最多150多个节点)、支付支付宝、微信、适合节点要求多的用户|[1.点击注册 → ](https://suying222.net/auth/register?code=5J5c)<br/> 2.在首页右下角获取订阅连接 |
...
|:-----------------:|:-----------------:|:--------------------:|:-------------------------:|:--------------------------------:|
|**V2ray教程[使用最广泛]** |[1.V2rayN](V2rayN_Windows.md) <br/> [2.Qv2ray](https://github.com/githubvpn007/v2rayNvpn/wiki/Qv2ray-for-Win)  <br/>  [3.V2rayW](https://github.com/githubvpn007/V2rayW) <br/> [4.V2RayS](https://github.com/githubvpn007/V2RayS)|[1.v2rayX](V2rayX_MacOs.md)|[1.V2rayNG](V2rayNG_Android.md)|[1.Kitsunebi](Kitsunebi_ios.md)|
